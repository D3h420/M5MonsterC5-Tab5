    ...
    void (*apply_style)(lv_obj_t *))
{
    ...
    lv_obj_set_size(btn, LV_SIZE_CONTENT, UI_TOUCH_TARGET_PRIMARY + 4);
    if (apply_style) {
        apply_style(btn);
    }
    lv_obj_set_style_pad_left(btn, UI_SPACE_16 + UI_SPACE_4, 0);
    lv_obj_set_style_pad_right(btn, UI_SPACE_16 + UI_SPACE_4, 0);
...
lv_obj_t *ui_comp_create_page(lv_obj_t *parent)
{
    ...
    lv_obj_set_style_pad_row(page, UI_SPACE_16, 0);
    ...
    lv_obj_t **actions_out)
{
    ...
    lv_obj_set_style_pad_column(left, UI_SPACE_16, 0);
    ...
    lv_obj_set_style_pad_column(actions, UI_SPACE_12, 0);
...
lv_obj_t *ui_comp_create_section(lv_obj_t *parent, const char *title, const char *subtitle)
{
    ...
    lv_obj_set_style_pad_row(section, UI_SPACE_12, 0);
    ...
    void *user_data)
{
    ...
    lv_obj_clear_flag(card, LV_OBJ_FLAG_SCROLLABLE);
    lv_obj_set_style_pad_all(card, UI_SPACE_16, 0);
    lv_obj_set_style_pad_row(card, UI_SPACE_12, 0);
    ...
    lv_obj_set_style_text_color(caption, ui_theme_color(UI_COLOR_TEXT_SECONDARY), 0);
    ...
    void *user_data)
{
    ...
    lv_obj_set_style_pad_column(row, UI_SPACE_16, 0);
    ...
    lv_obj_set_style_text_color(chev, ui_theme_color(UI_COLOR_TEXT_MUTED), 0);
...
void ui_comp_create_modal(lv_obj_t *parent, lv_coord_t width, lv_coord_t height, lv_obj_t **overlay_out, lv_obj_t **card_out)
{
    ...
    lv_obj_set_flex_flow(card, LV_FLEX_FLOW_COLUMN);
    lv_obj_set_style_pad_row(card, UI_SPACE_16, 0);
    lv_obj_clear_flag(card, LV_OBJ_FLAG_SCROLLABLE);
...
void ui_comp_show_toast(lv_obj_t *parent, const char *message, uint32_t duration_ms)
{
    ...
    lv_obj_set_style_bg_grad_color(toast, ui_theme_color(UI_COLOR_SURFACE), 0);
    lv_obj_set_style_border_color(toast, ui_theme_color(UI_COLOR_ACCENT_SECONDARY), 0);
    lv_obj_set_style_border_width(toast, UI_BORDER_THICK, 0);
    lv_obj_set_style_radius(toast, UI_RADIUS_LG, 0);
