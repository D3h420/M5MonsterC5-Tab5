...
static lv_color_t s_palette[UI_COLOR_COUNT] = {
    ...
    [UI_COLOR_SURFACE] = LV_COLOR_MAKE(0x18, 0x22, 0x2C),
    [UI_COLOR_SURFACE_ALT] = LV_COLOR_MAKE(0x1F, 0x2A, 0x36),
    [UI_COLOR_CARD] = LV_COLOR_MAKE(0x18, 0x22, 0x2C),
    [UI_COLOR_BORDER] = LV_COLOR_MAKE(0x33, 0x43, 0x55),
    [UI_COLOR_TEXT_PRIMARY] = LV_COLOR_MAKE(0xF2, 0xF6, 0xFB),
    [UI_COLOR_TEXT_SECONDARY] = LV_COLOR_MAKE(0xC4, 0xCE, 0xDA),
    [UI_COLOR_TEXT_MUTED] = LV_COLOR_MAKE(0x8B, 0x98, 0xA8),
...
void ui_theme_init(lv_display_t *disp)
{
    ...
    lv_style_set_bg_opa(&s_styles.card, 178);
    ...
    lv_style_set_border_color(&s_styles.card, lv_color_mix(s_palette[UI_COLOR_BORDER], lv_color_white(), LV_OPA_10));
    ...
    lv_style_set_shadow_opa(&s_styles.card, LV_OPA_25);

    lv_style_init(&s_styles.section);
    lv_style_set_bg_opa(&s_styles.section, 170);
    lv_style_set_bg_color(&s_styles.section, s_palette[UI_COLOR_CARD]);
    lv_style_set_bg_grad_color(&s_styles.section, lv_color_lighten(s_palette[UI_COLOR_CARD], 4));
    ...
    lv_style_set_bg_opa(&s_styles.appbar, 168);
    lv_style_set_bg_color(&s_styles.appbar, s_palette[UI_COLOR_SURFACE]);
    lv_style_set_bg_grad_color(&s_styles.appbar, lv_color_lighten(s_palette[UI_COLOR_SURFACE], 3));
    ...
    lv_style_set_bg_opa(&s_styles.tabbar, 160);
    ...
    lv_style_set_bg_opa(&s_styles.button_pressed, LV_OPA_80);
    ...
    lv_style_set_bg_opa(&s_styles.icon_button, 190);
    ...
    lv_style_set_bg_opa(&s_styles.metric_card, 178);
    lv_style_set_bg_color(&s_styles.metric_card, s_palette[UI_COLOR_CARD]);
    lv_style_set_bg_grad_color(&s_styles.metric_card, lv_color_lighten(s_palette[UI_COLOR_CARD], 4));
    ...
    lv_style_set_shadow_width(&s_styles.metric_card, 14);
    lv_style_set_shadow_opa(&s_styles.metric_card, LV_OPA_20);
    lv_style_set_transition(&s_styles.metric_card, &s_button_transition);

    lv_style_init(&s_styles.list_row);
    lv_style_set_bg_opa(&s_styles.list_row, 178);
    lv_style_set_bg_color(&s_styles.list_row, s_palette[UI_COLOR_CARD]);
    lv_style_set_bg_grad_color(&s_styles.list_row, lv_color_lighten(s_palette[UI_COLOR_CARD], 4));
    ...
    lv_style_set_shadow_opa(&s_styles.list_row, LV_OPA_15);
    ...
    lv_style_set_bg_grad_color(&s_styles.modal_card, lv_color_lighten(s_palette[UI_COLOR_SURFACE], 4));
    lv_style_set_bg_grad_dir(&s_styles.modal_card, LV_GRAD_DIR_VER);
    lv_style_set_border_width(&s_styles.modal_card, UI_BORDER_THIN);
    lv_style_set_border_color(&s_styles.modal_card, s_palette[UI_COLOR_BORDER]);
    ...
    lv_style_set_shadow_width(&s_styles.modal_card, 22);
    lv_style_set_shadow_color(&s_styles.modal_card, lv_color_black());
    lv_style_set_shadow_opa(&s_styles.modal_card, LV_OPA_35);
