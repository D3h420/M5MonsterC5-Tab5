...
static lv_color_t s_palette[UI_COLOR_COUNT] = {
    [UI_COLOR_BG] = LV_COLOR_MAKE(0x07, 0x0D, 0x15),
    [UI_COLOR_BG_LAYER] = LV_COLOR_MAKE(0x0D, 0x15, 0x22),
    [UI_COLOR_SURFACE] = LV_COLOR_MAKE(0x12, 0x1D, 0x2E),
    [UI_COLOR_SURFACE_ALT] = LV_COLOR_MAKE(0x18, 0x26, 0x3A),
    [UI_COLOR_CARD] = LV_COLOR_MAKE(0x14, 0x22, 0x34),
    [UI_COLOR_BORDER] = LV_COLOR_MAKE(0x2B, 0x3E, 0x58),
    [UI_COLOR_TEXT_PRIMARY] = LV_COLOR_MAKE(0xF2, 0xF7, 0xFF),
    [UI_COLOR_TEXT_SECONDARY] = LV_COLOR_MAKE(0xC1, 0xCF, 0xDE),
    [UI_COLOR_TEXT_MUTED] = LV_COLOR_MAKE(0x88, 0x9C, 0xB1),
    [UI_COLOR_ACCENT_PRIMARY] = LV_COLOR_MAKE(0x20, 0xD6, 0xC2),
    [UI_COLOR_ACCENT_SECONDARY] = LV_COLOR_MAKE(0xFF, 0x9A, 0x3D),
    [UI_COLOR_SUCCESS] = LV_COLOR_MAKE(0x48, 0xD9, 0x8E),
    [UI_COLOR_WARNING] = LV_COLOR_MAKE(0xFF, 0xCA, 0x57),
    [UI_COLOR_ERROR] = LV_COLOR_MAKE(0xFF, 0x5E, 0x74),
    [UI_COLOR_INFO] = LV_COLOR_MAKE(0x5A, 0xBC, 0xFF),
...
static void init_button_style(lv_style_t *style, lv_color_t bg, lv_color_t border, lv_color_t text)
{
    ...
    lv_style_set_radius(style, UI_RADIUS_MD);
...
void ui_theme_init(lv_display_t *disp)
{
    ...
    lv_style_set_pad_row(&s_styles.page, UI_SPACE_12);
    ...
    lv_style_set_radius(&s_styles.card, UI_RADIUS_MD);
    ...
    lv_style_set_radius(&s_styles.section, UI_RADIUS_LG);
    ...
    lv_style_set_bg_opa(&s_styles.appbar, LV_OPA_COVER);
    ...
    lv_style_set_bg_opa(&s_styles.tabbar, LV_OPA_COVER);
    ...
    lv_style_set_radius(&s_styles.tabbar, 0);
    ...
    lv_style_set_translate_y(&s_styles.button_pressed, 2);
    lv_style_set_shadow_opa(&s_styles.button_pressed, LV_OPA_10);

    lv_style_init(&s_styles.button_disabled);
    lv_style_set_bg_color(&s_styles.button_disabled, s_palette[UI_COLOR_SURFACE]);
    ...
    lv_style_set_opa(&s_styles.button_disabled, LV_OPA_70);
    ...
    lv_style_set_radius(&s_styles.icon_button, UI_RADIUS_MD);
    ...
    lv_style_set_bg_opa(&s_styles.chip, LV_OPA_30);
    ...
    lv_style_set_text_font(&s_styles.chip, &lv_font_montserrat_14);

    lv_style_init(&s_styles.metric_card);
    lv_style_set_bg_opa(&s_styles.metric_card, LV_OPA_COVER);
    lv_style_set_bg_color(&s_styles.metric_card, s_palette[UI_COLOR_SURFACE_ALT]);
    lv_style_set_border_width(&s_styles.metric_card, UI_BORDER_THICK);
    lv_style_set_border_color(&s_styles.metric_card, s_palette[UI_COLOR_BORDER]);
    lv_style_set_radius(&s_styles.metric_card, UI_RADIUS_LG);
    lv_style_set_pad_all(&s_styles.metric_card, UI_SPACE_12);
    lv_style_set_pad_row(&s_styles.metric_card, UI_SPACE_8);
    ...
    lv_style_set_shadow_opa(&s_styles.metric_card, LV_OPA_15);
    ...
    lv_style_set_radius(&s_styles.list_row, UI_RADIUS_MD);
    ...
    lv_style_set_bg_opa(&s_styles.modal_overlay, LV_OPA_65);
    ...
    lv_style_set_radius(&s_styles.modal_card, UI_RADIUS_LG);
